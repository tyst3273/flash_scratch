...
s_ax.plot(e,i+shift,marker='o',ms=3,lw=1,c='k')
...
e, i = np.loadtxt(os.path.join(directory,filename),unpack=True)
as_ax.plot(e,i+shift,marker='o',ms=3,lw=1,c='k')
...
e, i = np.loadtxt(os.path.join(directory,filename),unpack=True)
s_ax.plot(e,i+shift,marker='o',ms=3,lw=1,c='r')
s_ax.plot([-1000,1000],[shift,shift],ms=0,lw=1,ls=(0,(1,1)),c=(0.25,0.25,0.25))
...
e, i = np.loadtxt(os.path.join(directory,filename),unpack=True)
as_ax.plot(e,i+shift,marker='o',ms=3,lw=1,c='r')
as_ax.plot([-1000,1000],[shift,shift],ms=0,lw=1,ls=(0,(1,1)),c=(0.25,0.25,0.25))
...
fig.supxlabel('Raman shift [1/cm]',fontsize='large',y=-0.05)
...
as_ax.annotate(r'TiO$_2$, 50mA',xy=(0.5,0.66),xycoords='axes fraction',fontsize='medium') 

#as_ax.annotate(r'Si, 0 mA',xy=(0.55,0.025),xycoords='axes fraction',fontsize='medium') 
as_ax.annotate('ambient',xy=(0.625,0.14),xycoords='axes fraction',fontsize='medium')
as_ax.annotate(r'Si, 750mA',xy=(0.55,0.425),xycoords='axes fraction',fontsize='medium') 


#s_ax.annotate(r'300 K',xy=(0.05,0.025),xycoords='axes fraction',fontsize='medium') 
s_ax.annotate(r'923 K',xy=(0.05,0.425),xycoords='axes fraction',fontsize='medium') 

s_ax.annotate(r'300 K',xy=(0.05,0.14),xycoords='axes fraction',fontsize='medium') 
s_ax.annotate(r'888 K',xy=(0.05,0.66),xycoords='axes fraction',fontsize='medium') 
